    ...
    <div className="min-h-screen" style={{ backgroundColor: '#ffffff' }}>
      <nav className="fixed top-0 left-0 right-0 z-50 shadow-md" style={{ backgroundColor: '#ffffff' }}>
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-bold" style={{ color: '#3b82f6' }}>Jude Sdn bhd</span>
          </div>
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6" style={{ color: '#3b82f6' }}>Jude Sdn bhd</h1>
          <p className="text-xl md:text-2xl mb-8 max-w-2xl mx-auto" style={{ color: '#1e293b' }}>your trursted cinnamon roll</p>
          <a href={`https://wa.me/601117957335`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-8 py-4 rounded-lg text-white font-semibold text-lg hover:opacity-90 transition-opacity" style={{ backgroundColor: '#f59e0b' }}>
      ...
      <section id="about" className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <p className="text-lg leading-relaxed" style={{ color: '#1e293b' }}>bla bla bla</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[{ t: 'Vision', d: 'bla bla la' }, { t: 'Mission', d: 'bla bla bal' }, { t: 'Innovation', d: 'Our commitment to innovation' }, { t: 'Excellence', d: 'Our dedication to excellence' }].map((p, i) => (
      ...
      <section id="services" className="py-20 px-4" style={{ backgroundColor: '#3b82f608' }}>
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {[{ n: 'Web Design', d: 'Bla ba', i: 'www.com' }, { n: 'Product 2', d: 'Description', i: 'https://placehold.co/400x300/e2e8f0/64748b?text=Product+2' }, { n: 'Product 3', d: 'Description', i: 'https://placehold.co/400x300/e2e8f0/64748b?text=Product+3' }, { n: 'Product 4', d: 'Description', i: 'https://placehold.co/400x300/e2e8f0/64748b?text=Product+4' }, { n: 'Product 5', d: 'Description', i: 'https://placehold.co/400x300/e2e8f0/64748b?text=Product+5' }].map((p, i) => (
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4"><MapPin size={24} style={{ color: '#f59e0b' }} className="mt-1 flex-shrink-0" /><p style={{ color: '#1e293b' }}>123 Jalan jalan</p></div>
              <div className="flex items-center gap-4"><Mail size={24} style={{ color: '#f59e0b' }} /><a href={`mailto:info@jude.com`} style={{ color: '#1e293b' }} className="hover:underline">info@jude.com</a></div>
              <div className="flex items-center gap-4"><Phone size={24} style={{ color: '#f59e0b' }} /><a href={`tel:+60 11-1795 7335`} style={{ color: '#1e293b' }} className="hover:underline">+60 11-1795 7335</a></div>
            </div>
      ...
      <footer className="py-8 px-4" style={{ backgroundColor: '#3b82f6' }}>
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white">&copy; {new Date().getFullYear()} Jude Sdn bhd. All rights reserved.</p>
